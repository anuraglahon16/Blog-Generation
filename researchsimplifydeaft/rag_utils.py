...
def generate_answer(query, db, llm):
    ...
    def generate_answer_with_tools(query):
        ...
        return agent.run(f"""
         Based on the user's requirements and questions about {query}, provide a comprehensive answer that addresses their specific concerns. Use the available tools to gather relevant information and provide a well-structured explanation.

        Consider the following points while generating your answer:
        - Address each of the user's specific questions and requirements.
        - Provide detailed explanations and examples where necessary.
        - Use the available tools to find relevant information and insights.
        - If one tool doesn't provide a satisfactory answer, try using the other tools to find additional information.
        - Structure your answer in a clear and logical manner.

        Remember to focus on the user's specific needs and tailor your answer accordingly.
        """)
